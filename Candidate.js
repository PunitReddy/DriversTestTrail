...
button1.option("None of them")
button1.option("A medium-sized passenger vehicle")
button1.option("A motorized rickshaw")
...
button1.option("1 second")
button1.option("4 seconds")
button1.option("2 seconds")
...
button1.option("Left on entry, nothing on exit")
button1.option("Nothing on entry, right on exit")
button1.option("Left on entry, right on exit")
...
button1.option("12.2 m")
button1.option("8.6 m")
button1.option("4.3 m")
...
button1.option("Four months")
button1.option("Twelve months")
button1.option("Eight months")
...
button1.option("Facing straight downhill")
button1.option("Turned towards the curb or edge of the road")
button1.option("However they were positioned when you stopped")
...
button1.option("48 hours")
button1.option("24 hours")
button1.option("12 hours")
...
button1.option("Switch to low beam headlights")
button1.option("Turn off your headlights")
button1.option("Sound your horn long and hard")
...
button1.option("Four months")
button1.option("Six months")
button1.option("Three months")
...
button1.option("Stop and let them cross")
button1.option("Move to the other side of the road to avoid them")
button1.option("Accelerate to get past them quickly")
...
button1.option("Maintain your current course and speed")
button1.option("Accelerate")
button1.option("Pull over as soon as it is safe to do so")
...
button1.option("Black letters, yellow background")
button1.option("Yellow letters, black background")
button1.option("White letters, blue background")
...
button1.option("Wait for a gap in the traffic then pull away with caution")
button1.option("Pull out as quickly as possible")
button1.option("Sound your horn as a warning")
...
button1.option("Come to a complete stop and wait for them to cross")
button1.option("Speed up to be past as quickly as possible")
button1.option("Slow down and wave them across")
